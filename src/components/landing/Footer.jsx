...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: GitHubIcon, href: 'https://github.com/mohitrhl', label: 'GitHub' },
    { icon: LinkedInIcon, href: 'https://www.linkedin.com/in/mohit-kumar001/', label: 'LinkedIn' },
  
  ];

  const contactInfo = [
    { icon: EmailIcon, text: 'mohit.dev0018@gmail.com' },
    { icon: PhoneIcon, text: '+8448569574' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {currentYear} OpenLeaf Library. All rights reserved.
            </p>
            ...
            <p className="text-gray-400 text-sm">
              Made with <span className="text-red-500">❤</span> by Mohit kumar
            </p>
          </div>
        </div>
      </div>
